  ...
  const handleConfirmDelete = () => {
    setTarefas(current =>
      current.filter(tarefa => {
        return tarefa.idTarefa !== idToDelete;
      }),
    );
    handleCloseDialog();
  };
    ...
    return(
    <>
    <Card sx={{ backgroundColor: '#f5f5f5', borderRadius: '10px', paddingTop: '1 rem' }}>
        <CardHeader
          title="Tarefas"
                ...
                {tarefas.map((row) => (
                  <TableRow
                    ...
                    sx={{
                      ...
                      backgroundColor: row.statusTarefa === 'Concluída' ? '#d4edda' : 'inherit',
                    }}
                  >
                    ...
                    <TableCell align="center">
                    <Button variant="contained" color="error" onClick={() => handleOpenDialog(row.idTarefa)}>
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen} sx={{ backgroundColor: '#4caf50', color: '#fff' }}>Criar Tarefa</Button>
            <Button size="small" variant="outlined" sx={{ borderColor: '#f44336', color: '#f44336' }}>Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
